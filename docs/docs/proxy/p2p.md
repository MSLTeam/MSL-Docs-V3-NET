...
STUN隧道仅适用于 ==NAT1全锥形=={.warning} 的网络类型，其他NAT类型均不支持打通此隧道。如果你一点也听不懂，建议您使用 Frp隧道或者点对点联机服务。

MSL 从v3.7.5.2版本起支持本功能。
...
2. ### 启动STUN隧道
   ...
   前往MSL的 ==联机== 页面，切换到 ==STUN隧道== ，输入您的本地服务器端口，点击启动即可。

   记得放行或关闭防火墙哦。

   ![image-20260629173358576](./assets/image-20260629173358576.png)
...
3. ### 连接 & 注意事项
   ...
   1.STUN隧道的IP地址和端口都是**随时可能变化**的，这取决于运营商配置。
