...
const doc = defineCollection({
  ...
  sidebar: [
    ...
    { text: '服务器设置', prefix: 'config', collapsed: false,icon:'gear', items: ['server-config', 'msl','backup'] },
    { text: '映射/联机', prefix: 'proxy', collapsed: false,icon:'rocket', items: ['frp','stun', 'p2p','frp-real-ip','server-no-port'] },
